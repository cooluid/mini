export const logSend = {
	info: (message: string, ...args: any[]) => window.electronAPI.invoke(RendererToMainChannels.LOG_UPDATE, 'info', message, ...args),
	warn: (message: string, ...args: any[]) => window.electronAPI.invoke(RendererToMainChannels.LOG_UPDATE, 'warn', message, ...args),
	error: (message: string, ...args: any[]) => window.electronAPI.invoke(RendererToMainChannels.LOG_UPDATE, 'error', message, ...args),
	debug: (message: string, ...args: any[]) => window.electronAPI.invoke(RendererToMainChannels.LOG_UPDATE, 'debug', message, ...args),
};
